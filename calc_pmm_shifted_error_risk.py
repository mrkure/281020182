...
# =============================================================================
# RESULTS FILE STRUCTURE SETTINGS
# =============================================================================
...
# =============================================================================
calc = '1'
results_file_abs_path = os.path.normpath('{}/{}/{}'.format(cwd, results_dir, results_name))
abs_path              = fio.get_files(cwd, extension = ['xlsx'], contains = [results_file_abs_path], not_contains=['~'], print_path=False)
...
#                                                     columns = ['root_dir', 'sample_dir', 'filename'] + sorted_columns + ['sample_hydra', 'p_diff_hydra', "p_diff_hydra-p_diff_at_22°C/13.5V", "result", 'volum_hydra_6_bar'])                 
...
#                            volum_hydra  = hydra_frame.loc[(hydra_frame['Ident No.'] == sample),['006_BerechnetesHubvolumen_6_0bar_3_Sp1']].values[0]
#                        elif pressure == 6000:
...
#                        filtered_frame.loc[(filtered_frame.sample_dir == sample) & (filtered_frame.pressure == pressure), ["volum_hydra_6_bar"] ] =  volum_hydra
#
...
## =============================================================================
#input_frame = pd.read_excel('{}/{}/{}'.format(cwd, results_dir, results_name),usecols=[i for i in range(17)])
